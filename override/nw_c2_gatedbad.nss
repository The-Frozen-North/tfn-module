...
- removed loot
- unsummon VFX appeared on the spawn location, not at current location
*/
...
// DEFAULT GENERIC BEHAVIOR (DO NOT TOUCH) *****************************************************************************************
    ...
    WalkWayPoints();           // Optional Parameter: void WalkWayPoints(int nRun = FALSE, float fPause = 1.0)
                               ...
                               //    combat.
//    GenerateNPCTreasure();     //* Removed, was exploitable
//    object oBalor = OBJECT_SELF;
//    DestroyObject(oBalor,60.0);
//    effect e = EffectVisualEffect(VFX_IMP_UNSUMMON);
//    location lLoc = GetLocation(oBalor);
