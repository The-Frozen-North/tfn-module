...
/*
Patch 1.72
- removes all effects when player respawned from dying state
- removes all persistent area of effects such as clouds in the area player came from
*/
...
void main()
{
    ...
    DelayCommand(2.5, SetLocalInt(OBJECT_SELF,sVarName,0));
