...
Patch 1.71
- corrected the skill bonus gap between 21 and 22lvl song
...
void main()
{
    ...
    eDamage = EffectDamageIncrease(nDamage, DAMAGE_TYPE_BLUDGEONING|DAMAGE_TYPE_SLASHING|DAMAGE_TYPE_PIERCING);
