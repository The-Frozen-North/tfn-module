...
void main()
{
    ...
    object item_new = set_armor_model_prev(oItem, ITEM_APPR_ARMOR_MODEL_LTHIGH, "parts_legs", oPC);
    item_new = set_armor_model_prev(item_new, ITEM_APPR_ARMOR_MODEL_RTHIGH, "parts_legs", oPC);
