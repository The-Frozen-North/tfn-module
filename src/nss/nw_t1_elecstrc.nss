...
void main()
{
    ...
    effect eLightning = EffectBeam(VFX_BEAM_LIGHTNING, oTarget, BODY_NODE_CHEST, FALSE, TRAP_VFX_SIZE_STRONG);
    effect eDam;
    effect eVis = EffectVisualEffect(VFX_IMP_LIGHTNING_S, FALSE, TRAP_VFX_SIZE_STRONG);
    ...
    if (nDamage > 0)
    {
        ...
        SetTrapTriggeredOnCreature(oTarget);
    }
    ...
    while (GetIsObjectValid(o2ndTarget) && nCount < nSecondary)
    {
        ...
        if(o2ndTarget != oTarget && !GetIsReactionTypeFriendly(oTarget))
        {
            ...
            if (nDamage > 0)
            {
                ...
                SetTrapTriggeredOnCreature(o2ndTarget, "strong electrical trap");
            }
