...
void main()
{
    ...
    effect eLightning = EffectBeam(VFX_BEAM_LIGHTNING, oTarget, BODY_NODE_CHEST, FALSE, TRAP_VFX_SIZE_EPIC);
    effect eDam;
    effect eVis = EffectVisualEffect(VFX_IMP_LIGHTNING_S, FALSE, TRAP_VFX_SIZE_EPIC);
    ...
    if (nDamage > 0)
    {
        ...
        SetTrapTriggeredOnCreature(oTarget, "epic lightning trap");
    }
