...
//Returns the current quest entry of the player
int GetJournalQuestEntry(string szPlotID, object oCreature);

int GetJournalQuestEntry(string szPlotID, object oCreature)
{//1.71: new function to help with journal scripting
return GetLocalInt(oCreature,"NW_JOURNAL_ENTRY"+szPlotID);
}
