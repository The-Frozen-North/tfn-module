...
// Set a password until everything is initialized and ready
    ...
    NWNX_Events_SubscribeEvent("NWNX_ON_QUICKCHAT_BEFORE", "2_on_pc_voiceb");
    NWNX_Events_SubscribeEvent("NWNX_ON_CLIENT_CONNECT_AFTER", "2_on_pc_connect");
    NWNX_Events_SubscribeEvent("NWNX_ON_CLIENT_DISCONNECT_AFTER", "2_on_pc_dconnect");

    NWNX_Events_SubscribeEvent("NWNX_ON_USE_SKILL_BEFORE", "2_on_pc_skillb");
    NWNX_Events_SubscribeEvent("NWNX_ON_USE_SKILL_AFTER", "2_on_pc_skilla");

    NWNX_Events_SubscribeEvent("NWNX_ON_HEALER_KIT_BEFORE", "2_on_pc_healkit");

    NWNX_Events_SubscribeEvent("NWNX_ON_ENTER_STEALTH_BEFORE", "2_on_pc_stealth");

    NWNX_Events_SubscribeEvent("NWNX_ON_TRAP_RECOVER_BEFORE", "2_on_pc_trap");
    NWNX_Events_SubscribeEvent("NWNX_ON_TRAP_FLAG_BEFORE", "2_on_pc_trap");
    NWNX_Events_SubscribeEvent("NWNX_ON_TRAP_DISARM_BEFORE", "2_on_pc_trap");
    NWNX_Events_SubscribeEvent("NWNX_ON_TRAP_SET_BEFORE", "2_on_pc_trap");

    NWNX_Events_SubscribeEvent("NWNX_ON_OBJECT_LOCK_BEFORE", "2_on_pc_lock");
    NWNX_Events_SubscribeEvent("NWNX_ON_OBJECT_UNLOCK_BEFORE", "2_on_pc_unlock");

    NWNX_Events_SubscribeEvent("NWNX_ON_ITEM_PAY_TO_IDENTIFY_AFTER", "3_mer_identify");
...
// and then re-create the area
       ...
       DelayCommand(0.001, ExecuteScript("3_area_init", oArea));
...
// For testing purposes, we shall skip creating treasures if local/no NWNX.
   ...
   {
        DelayCommand(0.0, ExecuteScript("3_gtreas_start", OBJECT_SELF));
   }
   else
   {
        SetEventScript(GetModule(), EVENT_SCRIPT_MODULE_ON_HEARTBEAT, "2_on_mod_heartb");
   }
}
