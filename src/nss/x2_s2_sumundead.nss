...
void main()
{
    ...
    {
        //Ghoul
        eSummon = EffectSummonCreature("sum_pm_ghoul",VFX_IMP_HARM,0.0f,0);
    }
    else if (nCasterLevel == 6)
    {
        //Shadow
        eSummon = EffectSummonCreature("sum_pm_shadow",VFX_IMP_HARM,0.0f,0);
    }
    else if (nCasterLevel == 7)
    {
        //Ghast
        eSummon = EffectSummonCreature("sum_pm_ghast",VFX_IMP_HARM,0.0f,1);
    }
    else if (nCasterLevel == 8)
    {
        //Wight
        eSummon = EffectSummonCreature("sum_pm_wight",VFX_FNF_SUMMON_UNDEAD,0.0f,1);
    }
