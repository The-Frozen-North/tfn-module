...
void AddFlamingEffectToWeapon(object oMyWeapon, float fDuration, int nCasterLevel)
{
    ...
    IPSafeAddItemProperty(oMyWeapon, ItemPropertyDamageBonus(IP_CONST_DAMAGETYPE_FIRE, IP_CONST_DAMAGEBONUS_1d6), fDuration, X2_IP_ADDPROP_POLICY_REPLACE_EXISTING);
}
