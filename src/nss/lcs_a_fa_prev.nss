...
void main()
{
    ...
    object item_new = set_armor_model_prev(oItem, ITEM_APPR_ARMOR_MODEL_LFOREARM, "parts_forearm", oPC);
    item_new = set_armor_model_prev(item_new, ITEM_APPR_ARMOR_MODEL_RFOREARM, "parts_forearm", oPC);
