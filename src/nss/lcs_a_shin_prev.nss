...
void main()
{
    ...
    object item_new = set_armor_model_prev(oItem, ITEM_APPR_ARMOR_MODEL_LSHIN, "parts_shin", oPC);
    item_new = set_armor_model_prev(item_new, ITEM_APPR_ARMOR_MODEL_RSHIN, "parts_shin", oPC);
