...
void main()
{
    ...
    object item_new = set_armor_model_prev(oItem, ITEM_APPR_ARMOR_MODEL_LFOOT, "parts_foot", oPC);
    item_new = set_armor_model_prev(item_new, ITEM_APPR_ARMOR_MODEL_RFOOT, "parts_foot", oPC);
