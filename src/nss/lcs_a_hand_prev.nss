...
void main()
{
    ...
    object item_new = set_armor_model_prev(oItem, ITEM_APPR_ARMOR_MODEL_LHAND, "parts_hand", oPC);
    item_new = set_armor_model_prev(item_new, ITEM_APPR_ARMOR_MODEL_RHAND, "parts_hand", oPC);
