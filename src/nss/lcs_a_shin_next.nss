...
void main()
{
    ...
    object item_new = set_armor_model_next(oItem, ITEM_APPR_ARMOR_MODEL_LSHIN, "parts_shin", oPC);
    item_new = set_armor_model_next(item_new, ITEM_APPR_ARMOR_MODEL_RSHIN, "parts_shin", oPC);
