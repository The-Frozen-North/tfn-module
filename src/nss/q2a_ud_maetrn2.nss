...
void main()
{
    ...
    object oTrigger = GetObjectByTag("q2amaetrig_right");
    ...
    {
        object oTarget = GetObjectByTag("q2a_maetarget_right");
    ...
    else
    {
        ...
        DelayCommand(0.5, ActionPlayAnimation(nAnimation, 1.0, 3.0));
    }
