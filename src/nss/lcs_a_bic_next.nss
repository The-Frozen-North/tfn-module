...
void main()
{
    ...
    object item_new = set_armor_model_next(oItem, ITEM_APPR_ARMOR_MODEL_LBICEP, "parts_bicep", oPC);
    item_new = set_armor_model_next(item_new, ITEM_APPR_ARMOR_MODEL_RBICEP, "parts_bicep", oPC);
