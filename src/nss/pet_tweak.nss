...
// stop if no master
    ...
    switch (nAssociateType)
    {
        ...
        case ASSOCIATE_TYPE_FAMILIAR: nMasterHitDice = GetLevelByClass(CLASS_TYPE_WIZARD, oMaster)+GetLevelByClass(CLASS_TYPE_SORCERER, oMaster)+GetLevelByClass(CLASS_TYPE_DRAGON_DISCIPLE, oMaster); break;
