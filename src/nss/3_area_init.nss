...
// Set some special area scripts
       SetEventScript(oArea, EVENT_SCRIPT_AREA_ON_HEARTBEAT, "3_area_hb");
       SetEventScript(oArea, EVENT_SCRIPT_AREA_ON_ENTER, "3_area_enter");
...
// add the resref to a spawn trigger tag
                 ...
                 case OBJECT_TYPE_DOOR:
                    SetEventScript(oObject, EVENT_SCRIPT_DOOR_ON_UNLOCK, "3_unlock");
// plot doors with an un-openable key cannot be bashed
                    ...
                    {
                        SetEventScript(oObject, EVENT_SCRIPT_DOOR_ON_MELEE_ATTACKED, "3_bash_lock");
                    }
                   SetEventScript(oObject, EVENT_SCRIPT_DOOR_ON_CLICKED, "");
                 break;
                 case OBJECT_TYPE_PLACEABLE:
                   SetEventScript(oObject, EVENT_SCRIPT_PLACEABLE_ON_UNLOCK, "3_unlock");
