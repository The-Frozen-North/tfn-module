...
- effect made supernatural, undispellable
*/
...
void main()
{
    if (! GetHasSpellEffect (GetSpellId()) )
    {
        ...
        ApplyEffectToObject(DURATION_TYPE_TEMPORARY,SupernaturalEffect(eLink),OBJECT_SELF,RoundsToSeconds(GetHitDice(OBJECT_SELF)));
    }
}
