...
object Global()
{
    return GetLocalObject(OBJECT_SELF,"NW_J_ARTIFACT_MYGLOBALS");
}
...
{
    SetLocalObject(oTarget,"NW_J_ARTIFACT_MYGLOBALS", oGlobal);
}
...
{
    SetLocalString(Global(), "NW_J_ARTIFACT_PLOT_TAG", sTag);
}
//::///////////////////////////////////////////////
//:: GetPlotTag
//:: Copyright (c) 2001 Bioware Corp.
...
string GetPlotTag()
{
    return GetLocalString(Global(), "NW_J_ARTIFACT_PLOT_TAG");
}
...
{
   SetLocalString(Global(), "NW_J_ARTIFACT_ITEM", sTag);
}
...
{
    return GetLocalString(Global(), "NW_J_ARTIFACT_ITEM");
}
